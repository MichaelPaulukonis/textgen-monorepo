...
console.log(
  'You need to get your OAuth tokens from Tumblr. Here are your options:\n'
)
...
console.log(
  "4. Look at any API request - you'll see oauth_token and oauth_token_secret in the headers"
)
...
console.log(
  "The tumblrwks library you're using can help with OAuth, but it's more complex.\n"
)
