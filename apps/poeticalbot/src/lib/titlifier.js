...
const Titlifier = function (options) {
  ...
  let titlefier = function (text, titlemethod) {
    ...
    let titleMethods = Object.keys(titleTypes)

    let fmMethods = new FuzzyMatching(titleMethods)

    let strategy

    // TODO: do not pick an inappropriate strategy
    // (eg, summary for too few senteces/words, or WordFreq for zero words)
